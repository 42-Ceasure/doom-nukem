...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/09 09:29:30 by agay              #+#    #+#             */
/*   Updated: 2019/04/09 09:56:37 by agay             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_wall(t_draw *d, t_env *w, t_map *m, int x)
{
	int		box[2];
...
void	wall_to_wall(t_draw *d, t_reader *read, t_map *m, t_env *w)
{
	...
	while (d->point < m->sector[read->now.sectorno].wall_count)
	{
		...
		draw_wall(d, w, m, mooving_head(d, *read, m));
