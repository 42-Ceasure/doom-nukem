...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/09 09:18:44 by agay              #+#    #+#             */
/*   Updated: 2019/04/09 10:08:41 by agay             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_mini_map(t_map *m, t_draw *d, int point, int sector)
{
	...
	d->t1.x = -(d->v1.x * PL_AS - d->v1.y * PL_AC) * 10 + (WIDTH / 2);
	d->t1.y = -(d->v1.x * PL_AC + d->v1.y * PL_AS) * 10 + (HEIGHT / 2);
	d->t2.x = -(d->v2.x * PL_AS - d->v2.y * PL_AC) * 10 + (WIDTH / 2);
	d->t2.y = -(d->v2.x * PL_AC + d->v2.y * PL_AS) * 10 + (HEIGHT / 2);
}
