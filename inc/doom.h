...
/*   Updated: 2019/07/24 14:09:39 by ochaar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ceiling_and_floor(t_work *d, t_map *m, t_reader read, int point);
...
t_lstlst		*recursive_triangulate(t_env *w, t_win *win, t_lstlst *tmp2, t_lst *polygone);
t_lstlst		*stock_triangles(t_env *w, t_win *win, t_lstlst *triangles, t_lstlst *tmp3, t_lst *poly);
